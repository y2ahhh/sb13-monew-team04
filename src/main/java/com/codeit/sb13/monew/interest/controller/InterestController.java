...
public class InterestController {
     ...
     * 확인해 {@code INT_006}(400)으로 응답한다. {@code cursor}(이전 페이지 마지막 항목의 id)와
     * {@code after}(생성 시각)는 이전 응답의 {@code nextCursor}/{@code nextAfter}를 그대로
     * 돌려보내는 값으로, 첫 페이지 조회 시에는 생략한다.</p>
     *
